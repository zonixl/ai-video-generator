...
export const ImageModernScene: React.FC<{scene: RemotionSceneSpec}> = ({scene}) => {
  ...
  return (
    <div style={{width: '100%', height: '100%', position: 'relative', overflow: 'hidden', background: '#0f172a'}}>
      {/* Gradient orbs */}
      <div style={{position: 'absolute', width: 600, height: 600, borderRadius: '50%', background: 'radial-gradient(circle, rgba(59,130,246,0.35), transparent 70%)', top: -200, left: -150, filter: 'blur(80px)', opacity: breathe}} />
      <div style={{position: 'absolute', width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(168,85,247,0.3), transparent 70%)', bottom: -150, right: -100, filter: 'blur(80px)', opacity: breathe}} />
      {/* Grid lines */}
      ...
      <div style={{
        ...
        fontSize: 64, fontWeight: 800, color: '#f1f5f9', lineHeight: 1.2,
      ...
      <div style={{
        ...
        width: 800, borderRadius: 24, overflow: 'hidden',
        ...
        {imageUrl ? (
          <Img src={imageUrl} style={{width: '100%', height: 540, objectFit: 'cover'}} />
        ) : (
          <div style={{width: '100%', height: 540, background: 'linear-gradient(135deg, #1e3a5f, #312e81)'}} />
        )}
      </div>
      ...
      {scene.subtitle ? (
        <div style={{
          ...
          fontSize: 32, color: 'rgba(255,255,255,0.85)', lineHeight: 1.7, fontWeight: 400,
