  ...
  return (
    <div style={{width: '100%', height: '100%', position: 'relative', overflow: 'hidden', background: '#111'}}>
      ...
      <div style={{
        ...
        fontSize: r.titleFontSize, fontWeight: 900, color: '#fff', lineHeight: 1.2, letterSpacing: 2,
      ...
      {scene.subtitle ? (
        <div style={{
          ...
          padding: `${height * 0.02}px ${width * 0.055}px`, background: 'linear-gradient(transparent, rgba(0,0,0,0.75))',
          zIndex: 10,
        }}>
          <div style={{
            fontSize: r.subtitleFontSize, color: '#fff', textAlign: 'center', lineHeight: 1.6, fontWeight: 500,
